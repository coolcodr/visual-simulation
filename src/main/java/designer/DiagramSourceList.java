...
public class DiagramSourceList extends JTree implements DNDComponentInterface, DragSourceListener, DragGestureListener, MouseListener, Cloneable {
    /**
     * 
     */
    private static final long serialVersionUID = 1722057666869095935L;
    ...
    /*
     * public Object clone () { DiagramSourceList clonedList ;//= null; /* try {
     * clonedList = (DiagramSourceList)super.clone(); } catch (
     * CloneNotSupportedException ex ) { return null; }
     * 
     * DefaultMutableTreeNode newRoot = (DefaultMutableTreeNode) root.clone();
     * 
     * for ( int i = 0 ; i < root.getChildCount() ; i ++ ) { newRoot.add(
     * cloneNode ( (DefaultMutableTreeNode) root.getChildAt(i) ) ); }
     * 
     * clonedList = new DiagramSourceList( newRoot );
     * 
     * clonedList.inputComponent = (Vector) inputComponent.clone();
     * clonedList.inputComponentInternal = (Vector)
     * inputComponentInternal.clone(); clonedList.componentTable = (Hashtable)
     * componentTable.clone();
     * 
     * return clonedList; } private DefaultMutableTreeNode cloneNode (
     * DefaultMutableTreeNode node ) { DefaultMutableTreeNode clonedNode =
     * (DefaultMutableTreeNode) node.clone(); for ( int i = 0 ; i <
     * node.getChildCount() ; i ++ ) { clonedNode.add( cloneNode (
     * (DefaultMutableTreeNode) node.getChildAt(i) ) ); } return clonedNode; }
     */
    public DiagramSourceList(DefaultMutableTreeNode s) {
        super(s);
        root = s;
        // dropTarget1 = new DropTarget (this,
        // DesignerControl.currentUpperPane);
        dragSource = new DragSource();
        dragSource.createDefaultDragGestureRecognizer(this, DnDConstants.ACTION_MOVE, this);
        addMouseListener(this);

        inputComponent = new Vector();
        inputComponentInternal = new Vector();
    ...
    public void mousePressed(MouseEvent event) {
        ...
        if (selected != null && selected.getParentPath() != getPathForRow(0)) {
            ...
            /*
             * try{ //sourceTable = new
             * DiagramSourceTable(((DiagramComponentSetPanel
             * )selectedObject).getInternalValueNode()); DefaultMutableTreeNode
             * internalNode =
             * (DefaultMutableTreeNode)((DiagramComponentSetPanel)
             * selectedObject).getInternalValueNode();
             * 
             * for ( int i = 0 ; i < internalNode.getChildCount() ; i ++ )
             * selectedNode
             * .add((DefaultMutableTreeNode)internalNode.getChildAt(i));
             * 
             * selectedNode.setAllowsChildren(true); this.repaint();
             * }catch(Exception e){}
             * 
             * //System.out.println(((DefaultMutableTreeNode)((
             * DiagramComponentSetPanel
             * )selectedObject).getInternalValueNode()).getChildCount());
             * ((UIDesigner
             * )UIDesigner.mainWindow).setDiagramSourceTable(sourceTable);
        ...
        /*
         * DesignerUI.currentSetPanel =
         * (designer.DiagramComponentSetPanel)(((DefaultMutableTreeNode
         * )(this.getSelectionPath().getLastPathComponent())).getUserObject());
         * DesignerUI.createFrameButton.setEnabled(false);
         * System.out.println(((DefaultMutableTreeNode
         * )this.getSelectionPath().getLastPathComponent()).getChildCount()); if
         * (
         * ((DefaultMutableTreeNode)this.getSelectionPath().getLastPathComponent
         * ()).getChildCount() >0 )
         * DesignerUI.createFrameButton.setEnabled(true); Vector vPropertise =
         * ((designer.DiagramComponentSetPanel)(((DefaultMutableTreeNode)(this.
         * getSelectionPath
         * ().getLastPathComponent())).getUserObject())).getPropertise(); //if (
         * vPropertise.size() > 0 ) //{ DesignerUI.jTable.setModel(new
         * TableAdapter(vPropertise)); DesignerUI.jTable.repaint(); //}
         */
    }
    ...
    public void mouseReleased(MouseEvent event) {
        if (event.isPopupTrigger()) {
            ...
            if (row != -1) {
                ...
                // selectedObject = ( (DefaultMutableTreeNode)
                // (selected.getLastPathComponent())).getUserObject();
    ...
    public void popupMenu(Object selectedObject, int x, int y) {
        ...
        // if (selected != null && selected.getParentPath() ==
