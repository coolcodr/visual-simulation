...
public class TableAdapter extends AbstractTableModel
{
    ...
    public Object getValueAt(int row, int col)
    {
        if ( col == 0 )
            ...
            return
						((Object[])propertise.elementAt(row))[1] != null ?
						(
							(
        ...
        if(col == 0)
            ...
            if(p.getValue() != null) {
                if(isPrimitive(p.getType())) {
                    ...
                    String className = ((String)p.getValue().getClass().getName());
    ...
    public Class getColumnClass(int c) {
        ...
        //if(rowIndex != -1){
        //    table.getColumnModel().getColumn(c).setCellEditor(new CEditor(new JTextField()));
        //}
