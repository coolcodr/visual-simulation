...
public class Associations {
    ...
    public DiagramElement getParent(DiagramElement d) { // for the port find out
                                                        // the parent
    ...
    public DiagramElement getConnectorSource(DiagramElement d) { // for the
                                                                 // connector
                                                                 // find out the
                                                                 // source
        DiagramElement result = null;
    ...
    public DiagramElement getConnectorTarget(DiagramElement d) { // for the
                                                                 // connector
                                                                 // find out the
                                                                 // target
        DiagramElement result = null;
