...
public class ReportMultiPage implements Printable, Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 4187091826841718039L;
    ...
    /*
     * public ReportMultiPage() { this ( new ReportPage[1], 1 ); }
     */
    ...
    public int print(Graphics g, java.awt.print.PageFormat pf, int pi) throws PrinterException {
        ...
        // g2d.drawRect( (int)(pf.getImageableWidth() - (pageFormat.getWidth() *
        // scale * numOfHor )) /2 , (int)(pf.getImageableHeight() -
        // (pageFormat.getHeight() * scale * numOfVer))/2, 100,100 );
        ...
        for (int i = 0; i < numOfHor * numOfVer; i++) {
            ...
            int borderWidth = (int) pageFormat.getWidth();// - 20 ;//-
                                                          // (int)pageFormat.getImageableX();
            int borderHeight = (int) pageFormat.getHeight();// - 20 ;//-
      ...
      * public void setMultiPage ( int i ) { pagePerPage = i; } /* public int
      * getMultiPage ( ) { return pagePerPage; }* public void setDirection ( int
      * i) { pageDirection = i; }
      */
}
