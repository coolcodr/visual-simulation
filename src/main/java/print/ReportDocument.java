...
public class ReportDocument implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 7214782924596159208L;
    ...
    public ReportDocument() {
        ...
        multiPageFormat.setOrientation(java.awt.print.PageFormat.PORTRAIT);

        // TEMP
        setMultiPage(1, 1);
        setMultiPageDirection(DialogMultiPage.DIRECTION_ACCROSS);
        setMultiPageBoarder(DialogMultiPage.BOARDER_OFF);
        setMultiPageOrientation(java.awt.print.PageFormat.PORTRAIT);
    ...
    public void addReportPage(ReportPage reportPage) {
        ...
        this.reportPage[numOfReportPage].setHeaderFooter(pCHeaderFooter);
        numOfReportPage++;
    }
    ...
    public void updateStartPage(boolean preview) {
        ...
        for (i = 0; i < numOfReportPage; i++) {
            ...
            startPage = startPage + reportPage[i].getNumOfPage();
    ...
    /*
     * public void setMuultipage ( int i ) { multiPage = i; }
     */
    ...
    /*
     * public void updatePageAndTime () { Book book = new Book();
     * 
     * for ( int i = 0 ; i < numOfReportPage ; i ++ ) book.append(reportPage[i],
     * new PageFormat(), reportPage[i].getNumOfPage()); for ( int i = 0 ; i <
     * book.getNumberOfPages() ; i ++ ) {
