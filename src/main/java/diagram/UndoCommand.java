...
//		this.oldvalue = value;
    ...
    public boolean restore() {
        ...
        if (undoType == RESIZE_MOVE) {// resize diagram shape undo
            ...
            if (undoOrRedo == REDO) {
                ...
                DiagramElement d = DiagramShape.getDiagram().getDiagramControl().addDiagramSelection(_de, _de.getX(), _de.getY());
            ...
            DiagramShape.getDiagram().getDiagramControl().removeDiagramElement(_dc);
        }
    ...
    public UndoCommand createInverseCommand() {
        ...
        if (undoType == RESIZE_MOVE) {
            ...
            cmd = new UndoCommand(_p, _newpValue, _oldpValue);// Inverse two
                                                              // value
        } else if (undoType == ADDSHAPE) {
