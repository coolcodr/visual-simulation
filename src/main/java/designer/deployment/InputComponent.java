...
public class InputComponent implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -4018493416210594177L;
    ...
    public InputComponent(JLayeredPane jLayeredPane, String name, String setMode, GetDataInput getMode, Object defaultValue) {
        panelComponent = new InputComponentPropertise(jLayeredPane);
        this.name = name;
    ...
    public void setButton(JButton jComponent) {
        ...
        // dActionComponent = new DeployActionComponent(jComponent, new
        // DActionShow() );
    ...
    void comboBox_itemStateChanged(ItemEvent e) {
        ...
        // System.out.println("CARDPANE COMPONENT COUNT: " +
        // cardPane.getComponentCount());
