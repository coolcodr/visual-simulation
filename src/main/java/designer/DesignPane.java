...
public class DesignPane extends JLayeredPane {
     ...
     * 
     */
    private static final long serialVersionUID = 5301332264066591426L;
    ...
    public DesignPane(String id, String title) {
        ...
        bottomPane = new DesignBottomPane();
        upperPane = new DesignUpperPane(this);
        ...
        resizePoint = new DesignPaneResizeControl[6];
        for (int i = 0; i < 6; i++) {
    ...
    public void restoreButtonStatus(DesignPane designPane) {
        DesignBackPane backFrame = designPane.getBackFrame();
    ...
    /*
     * public void setLocation ( int x, int y ) { //super.setLocation(x, y); if
     * ( backPane != null ) { backPane.setLocation(x, y);
    ...
    public void setBounds(int x, int y, int width, int height) {
        ...
        if (parentCardPane != null) {
            ...
            if (x + width > d.width - 10 && x + width < d.width + 10) {
                x = d.width - width;
            }
            if (y + height > d.height - 10 && y + height < d.height + 10) {
                y = d.height - height;
            }
        }
    ...
    public void addDesignComponent(DesignerComponent designerComponent, boolean createUndo) {
        ...
        setPaneComponent.add(designerComponent);
        coverComponent.add(cover);

        addComponentToPane(designerComponent, cover);
        ...
        // DiagramComponentSetPanel firstSetPane = (DiagramComponentSetPanel)
        // setPaneComponent.elementAt(0);
        // firstSetPane.setCardPane((CardPane) designerComponent);
        /*
         * DiagramComponentSetPanel firstSetPane = (DiagramComponentSetPanel)
         * setPaneComponent.elementAt(0); firstSetPane.setCardPane( (CardPane)
         * jComponent); firstSetPane.addPaneToCardPane( (DesignPane)
         * DesignerControl.designPanes.elementAt(1) );
         * //firstSetPane.addPaneToCardPane( (DesignPane)
         * DesignerControl.designPanes.elementAt(2) );
    ...
    /*
     * public void addObject ( Component component ) { DiagramComponentSetPanel
     * setPanel = null; if ( component instanceof DiagramComponentSetPanel )
     * setPanel = (DiagramComponentSetPanel) component; else {
     * addComponent((JComponent)component); return; }
     * 
     ...
     * );
     * 
     * setPanel.setCover(coverComponent); coverComponent.addCoverListener();
     * 
     * //Set pane component this.setPaneComponent.add( component );
     * this.addComponentToPane( component, coverComponent); }
     */
    /*
     * public void addComponent ( JComponent jComponent ) { CoverComponent
     * coverComponent = new CoverComponent( jComponent, 4, true );
     * 
     * if ( jComponent.getParent() != null )
     * jComponent.getParent().remove(jComponent);
     * 
     * //SUPER TEMP if ( jComponent instanceof CardPane ) {
     * DiagramComponentSetPanel firstSetPane = (DiagramComponentSetPanel)
     * setPaneComponent.elementAt(0); firstSetPane.setCardPane( (CardPane)
     * jComponent); } //Temp coverComponent.addCoverListener(); //Temp
     * 
     * //Other component this.otherComponents.add(jComponent);
     * this.addComponentToPane(jComponent, coverComponent); }
     */
    /*
     * public void addActionComponent ( Component component ) { CoverComponent
     * coverComponent = new CoverComponent ( component, 4, false );
     * 
     * //Action component this.actionComponent.add( component );
     * this.addComponentToPane( component, coverComponent ); }
     */
    ...
    private void addComponentToPane(DesignerComponent designerComponent, CoverComponent coverComponent) {
        ...
        if (designerComponent instanceof DiagramComponentSetPanel) {
            ...
            DesignerControl.setGenerateEnalble(((DiagramComponentSetPanel) designerComponent).getComboBox().isVisible());
...
class UpperPaneResizeListener extends MouseAdapter {
    public void mousePressed(MouseEvent e) {
        ...
        if (designPane.getParent() != null && designPane.getParent().getParent().getParent() != null && !(designPane.getParent().getParent() instanceof CardPane)) {
