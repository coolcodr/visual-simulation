...
public class DeployObject implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 7977337691919825199L;
    ...
    // A terrible link in frameObject, there are some inputObject and
    // internalInputObject or action object those are exactly
    ...
    public InputComponent getInputObject(String name, String setMode) {
        ...
        /*
         * InputComponent result = null; for ( int i = 0 ; i <
         * inputObject.size() ; i ++ ) { InputComponent current =
         * (InputComponent)(inputObject.elementAt(i));
         * 
         * if ( current.getName().equalsIgnoreCase(name) &&
         * current.getSetMode().equalsIgnoreCase(setMode) ) result = current; }
         */
        return result;
    ...
    public InputComponent getInternalInputObject(String name, String setMode) {
         ...
         * (InputComponent)(internalInputObject.elementAt(i)); if (
