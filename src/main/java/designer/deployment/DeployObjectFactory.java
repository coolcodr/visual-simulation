...
public class DeployObjectFactory
{
    ...
    public DeployObjectFactory(DeployObject deployObject)
    {
        ...
        this.analysisTable = new Hashtable();

        this.pReader = new PropertiesTableReader();
    }
    ...
    public void initDocument(ReportDocument reportDocument, Hashtable analysis, Hashtable charts)
    {
        ...
        for (int i = 0; i < pageCount; i++)
        {
            ...
            //Object chart = analysis.get(diagram.getObjectComponent().getID());
            ...
            if (charts.get(diagram.getObjectComponent().getID()) != null)
            {
                ...
                diagram.getObjectComponent().add((Chart)charts.get(diagram.getObjectComponent().getID()));
                diagram.getObjectComponent().updateUI();
            ...
            /*
                         ...
                         {
                if ( charts[j].getDataSource().equals(analysisTool) )
    ...
    public void traceValue(StyledDocument sDocument, Hashtable anlysisTable)
    {
        ...
        try
        {
            ...
            while (matcher.find())
            {
                ...
                //try
                //{
                //replaceString = stringTable.get(match.substring(3, match.length() - 3)).toString();
                Object object;
                 ...
                 */
                MutableAttributeSet attr = (MutableAttributeSet) sDocument.getLogicalStyle(start);
    ...
    public Hashtable initTable() throws InvalidDataException
    {
        ...
        for (int i = 0; i < numberOfInputObject; i++)
        {
            ...
            try
            {
                ...
                /* System.out.println( variableName + " / " + currentInputComponent.getInput() );
                                 System.out.println( setMode + " / " + currentInputComponent.getInput());*/

                if (setMode.equalsIgnoreCase("Object Creator") || setMode.equalsIgnoreCase("Distribution") ||
                    setMode.equalsIgnoreCase("Transform") || setMode.equalsIgnoreCase("SplitterModel") || setMode.equalsIgnoreCase("MergerModel"))
                {
                    ...
                    /*int dotPosition = object.getClass().getName().lastIndexOf(".");
                                         String className = object.getClass().getName().substring(dotPosition+1);*/
                    ...
                    for (int j = 0; j < pDataAry.length; j++)
                    {
                        ...
                        if (getMethod != null && !getMethod.equals("null"))
                        {
                            ...
                            //System.out.println("["+i+"]"+">>>>3: "+interInputComponentToFind + ", " + pDataAry[j].getName());
                            Object getInput[] = new Object[1];
                            Class[] classPara = new Class[1];

                            //System.out.println(deployObject.getInternalInputObject(interInputComponentToFind, pDataAry[j].getName()).getInput());
    ...
    private void qsort(int lo, int hi, int[] in, int newin[])
    {
        ...
        guessed_median = newin[ (int) ( (lo + hi) / 2)];
