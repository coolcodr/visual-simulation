...
public class PropertiesTableData {
    ...
    public static final int PARENT_TYPE = 0; // this property's parent (the
                                             // Class name)
    public static final int PARENT = 1; // this property's parent (the Class
                                        // name)
    ...
    public static final int INPUT_METHOD = 6; // the component for user input of
                                              // this property (the Class name)
