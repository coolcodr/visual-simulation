...
public class ResizePoint extends JComponent implements MouseListener, MouseMotionListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		undoCommand = new UndoCommand(_diagramShape,undovalue,undomethod);//new UndoCommand
...
*/		
		...
		((DiagramShape) _diagramShape).repaintAssociations();
		((DiagramShape) _diagramShape).showResizePoints();
	}
