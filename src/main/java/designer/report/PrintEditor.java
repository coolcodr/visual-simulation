...
public class PrintEditor extends JFrame {
    ...
    private JButton jButton1New = new JButton(new ImageIconHelper().getImageIcon("/print/images/New16.gif"));
    private JButton jButton1Open = new JButton(new ImageIconHelper().getImageIcon("/print/images/Open16.gif"));
    private JButton jButton1Save = new JButton(new ImageIconHelper().getImageIcon("/print/images/Save16.gif"));
    private JButton jButton1PageSetup = new JButton(new ImageIconHelper().getImageIcon("/print/images/PageSetup16.gif"));
    private JToggleButton jButton1Preview = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/PrintPreview16.gif"));
    private JButton jButton1Print = new JButton(new ImageIconHelper().getImageIcon("/print/images/Print16.gif"));
    private JButton jButton1ZoomIn = new JButton(new ImageIconHelper().getImageIcon("/print/images/ZoomIn16.gif"));
    private JButton jButton1ZoomOut = new JButton(new ImageIconHelper().getImageIcon("/print/images/ZoomOut16.gif"));
    private JMenuItem jMenuItem1 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/New16.gif"));
    private JMenuItem jMenuItem2 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Open16.gif"));
    private JMenuItem jMenuItem3 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Blank16.gif"));
    private JMenuItem jMenuItem5 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Save16.gif"));
    private JMenuItem jMenuItem6 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Blank16.gif"));
    private JMenuItem jMenuItem8 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/PageSetup16.gif"));
    private JMenuItem jMenuItem9 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/PrintPreview16.gif"));
    private JMenuItem jMenuItem10 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Print16.gif"));
    private JMenuItem jMenuItem4 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Blank16.gif"));
    private JPanel jPanel3 = new JPanel();
    private JToggleButton jButton2AlignLeft = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/AlignLeft16.gif"));
    private JPanel jToolBar2 = new JPanel();
    private BorderLayout borderLayout3 = new BorderLayout();
    private JSplitPane jSplitPane1 = new JSplitPane();
    private JComboBox jComboBox1 = new JComboBox();
    private JToggleButton jButton2AlignCenter = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/AlignCenter16.gif"));
    private JToggleButton jButton2AlignRight = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/AlignRight16.gif"));
    private JToggleButton jButton2AlignJustify = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/AlignJustify16.gif"));
    private JComboBox jComboBox2Font = new JComboBox();
    private JComboBox jComboBox2Size = new JComboBox();
    private JToggleButton jButton2Bold = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/Bold16.gif"));
    private JToggleButton jButton2Italic = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/Italic16.gif"));
    private JToggleButton jButton2Underline = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/Underline16.gif"));
    private JToggleButton jButton2Text = new JToggleButton(new ImageIconHelper().getImageIcon("/print/images/Text16.gif"));
    private JButton jButtonCenter = new JButton(new ImageIconHelper().getImageIcon("/print/images/GraphJusCenter16.gif"));
    private JButton jButtonFitHoz = new JButton(new ImageIconHelper().getImageIcon("/print/images/GraphJusHorizontal16.gif"));
    private JButton jButtonFitVer = new JButton(new ImageIconHelper().getImageIcon("/print/images/GraphJusVertical16.gif"));
    private JButton jButtonDelete = new JButton(new ImageIconHelper().getImageIcon("/print/images/Delete16.gif"));
    ...
    private JMenuItem jMenuItem22 = new JMenuItem(new ImageIconHelper().getImageIcon("/print/images/Blank16.gif"));
