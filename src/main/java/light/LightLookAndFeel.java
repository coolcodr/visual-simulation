...
public class LightLookAndFeel extends MetalLookAndFeel
{
    ...
    public static FontUIResource getControlTextFont()
    {
        ...
        return new FontUIResource("Verdana", Font.ITALIC, 18);
    }
    ...
    public static FontUIResource getSubTextFont()
    {
        ...
        ColorUIResource uir = new ColorUIResource(0, 0, 0);
        ColorUIResource uir2 = new ColorUIResource(0, 0, 255);

        Object[] systemColors = {
                "desktop", uir, /* Color of the desktop background
          "activeCaption", uir, /* Color for captions (title bars) when they are active.
      "activeCaptionText", uir, /* Text color for text in captions (title bars).
    "activeCaptionBorder", uir, /* Border color for caption (title bar) window borders.
        "inactiveCaption", uir, /* Color for captions (title bars) when not active.
    "inactiveCaptionText", uir, /* Text color for text in inactive captions (title bars).
  "inactiveCaptionBorder", uir, /* Border color for inactive caption (title bar) window borders. *
                 "window", uir, /* Default color for the interior of windows *
           "windowBorder", uir, /* ??? *
             "windowText", uir, /* ??? *
                   "menu", uir2, /* Background color for menus *
               "menuText", uir, /* Text color for menus  *
                   "text", uir, /* Text background color *
               "textText", uir, /* Text foreground color *
          "textHighlight", uir, /* Text background color when selected *
      "textHighlightText", uir, /* Text color when selected *
       "textInactiveText", uir, /* Text color when disabled *
     ...
     "controlLtHighlight", uir, /* Highlight color for controls *
          "controlShadow", uir, /* Shadow color for controls *
        "controlDkShadow", uir, /* Dark shadow color for controls *
              "scrollbar", uir, /* Scrollbar background (usually the "track") *
                   "info", uir, /* ToolTip Background *
