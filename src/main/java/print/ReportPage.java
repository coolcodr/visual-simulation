...
public class ReportPage implements Printable, Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 4757008056807625404L;
    ...
    public ReportPage(PCHeaderFooter headerFooter) {
         ...
         * ); //String tempH = new String("Page 10 of 100"); String tempH = new
         * String("Testing Header and Footer"); JTextPane jTextPane1 = new
         * JTextPane(); jTextPane1.setText(tempH); StyledDocument styleddocument
         ...
         * StyleConstants.setAlignment(styleCENTER,
         * StyleConstants.ALIGN_CENTER); Style styleRIGHT =
         * styleddocument.addStyle("RIGHT", null);
    ...
    public void addParagraph(StyledDocument styledDocument, int pi, int x, int y, int width, int height) {
        if (numOfPCParagraph == pcParagraph.length) {
            expandParagraph();
        }
     ...
     * //pcPageNumber.getpcPageNumber. JTextPane style =
     * pcPageNumber.getStyle(); String s1 = pcPageNumber.getFirstString();
     * String s2 = pcPageNumber.getSecondString(); pcPageNumber = new
     * PCPageNumber(); pcPageNumber.addPageNumber(style);
     * pcPageNumber.setPageFormat(pf); pcPageNumber.setFirstString(s1);
     * pcPageNumber.setSecondString(s2); pcPageNumber.setText( pageNumber,
     * totalPageNumber ); pcDateTime.setDateTime(); }
     */
