...
public class UIDesigner extends JFrame
{
    ...
    //private static DefaultMutableTreeNode level0 =  new DefaultMutableTreeNode("Diagram Element");
    protected static DiagramSourceList sourceList; //= new DiagramSourceList(level0);
  ...
  JMenuItem jMenuItem30 = new JMenuItem();//new ImageIcon("designer/images/Blank16.gif"));//BLANK
  ...
  JMenuItem jMenuItem36 = new JMenuItem();//new ImageIcon("designer/images/Blank16.gif"));//BLANK
  ...
  JMenuItem jMenuItem41 = new JMenuItem();//new ImageIcon("designer/images/Blank16.gif"));//BLANK
  ...
  JMenuItem jMenuItem42 = new JMenuItem(new ImageIcon("designer/images/Blank16.gif"));//BLANK
    ...
    public UIDesigner(DesignerControl designerControl)
    {
        ...
        this.reportControl = new ReportDesignerControl(this);
        try
        {
            jbInit();
        }
    ...
    this.setJMenuBar(jMenuBar1);
        ...
        this.setTitle("Deployment Application/Report Designer");
    ...
    this.getContentPane().add(tooBarPanel, BorderLayout.NORTH);
    ...
    jToolBar1.add(jButton32, null);
        ...
        Object[] s1 =
            {
            "Property 1", null}; //new FrameIDandName("0","Untitled Frame 1")};
        v1.add(s1);
        Object[] s2 =
            {
            "Property 2", new FrameIDandName("1", "Untitled Frame 2")};
        v1.add(s2);
        Object[] s3 =
            {
            "Property 3", new FrameIDandName("2", "Untitled Frame 3")};
        v1.add(s3);
        //TEMP//!!
        ...
        /*
                 sourceTable.setModel(new TableAdapter(new Vector()));
                 Box boxPermissionList = Box.createVerticalBox();
                 for (int i = 0; i < 10; i++) {
            boxPermissionList.add(new JCheckBox("Item " + i));
                 }
                 JScrollPane paneScrollPermission = new JScrollPane(boxPermissionList);
...
*/
    ...
    {
        //this.jSplitPane3.setDividerLocation(jSplitPane3.getHeight() - savedSplitHeight);
        super.paint(g);
        //sourceList.repaint();
    }
    ...
    public void setDiagramSourceList(DiagramSourceList list)
    {
        ...
        this.sourceList.expandPath(sourceList.getPathForRow(0));

        this.sourceList.setRootVisible(true);
  ...
  void jComboBoxFrame_itemStateChanged(ActionEvent e )
  {
      ...
      {
          DesignPane designPane = (DesignPane)object;// ( (JComboBox) e.getSource()).getSelectedItem();
