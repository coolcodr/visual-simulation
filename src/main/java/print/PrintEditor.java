...
public class PrintEditor extends JFrame
{
  ...
  JButton jButton6;//  = new JButton(new ImageIcon("print/images/ZoomOut16.gif"));
    ...
    private void setViewMode ()
    {
        ...
        jPanel1.add(jToolBar3, BorderLayout.NORTH);
    ...
    private void jbInit() throws Exception
    {
        ...
        url = PrintEditor.class.getResource("images/Open16.gif");
        jButton1Open = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Save16.gif");
        jButton1Save = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/PageSetup16.gif");
        jButton1PageSetup = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/PrintPreview16.gif");
        jButton1Preview = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Print16.gif");
        jButton1Print = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/ZoomIn16.gif");
        jButton1ZoomIn = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/ZoomOut16.gif");
        jButton1ZoomOut = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/New16.gif");
        jMenuItem1 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Open16.gif");
        jMenuItem2 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Blank16.gif");
        jMenuItem3 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Save16.gif");
        jMenuItem5 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Blank16.gif");
        jMenuItem6 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/PageSetup16.gif");
        jMenuItem8 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/PrintPreview16.gif");
        jMenuItem9 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Print16.gif");
        jMenuItem10 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Blank16.gif");
        jMenuItem4 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/AlignLeft16.gif");
        jButton2AlignLeft = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/AlignCenter16.gif");
        jButton2AlignCenter = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/AlignRight16.gif");
        jButton2AlignRight = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/AlignJustify16.gif");
        jButton2AlignJustify = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Bold16.gif");
        jButton2Bold = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Italic16.gif");
        jButton2Italic = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Underline16.gif");
        jButton2Underline = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Text16.gif");
        jButton2Text = new JToggleButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/GraphJusCenter16.gif");
        jButtonCenter = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/GraphJusHorizontal16.gif");
        jButtonFitHoz = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/GraphJusVertical16.gif");
        jButtonFitVer = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Delete16.gif");
        jButtonDelete = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Blank16.gif");
        jMenuItem22 = new JMenuItem(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/Print16.gif");
        jButton4 = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/ZoomIn16.gif");
        jButton5 = new JButton(new ImageIcon(url));
        url = PrintEditor.class.getResource("images/ZoomOut16.gif");
    ...
    jToolBar3.add(jButton6, null);
        ...
        jToolBar2.add(jButton2AlignRight, null);
        jToolBar2.add(jButton2AlignJustify, null);
        jToolBar2.add(jButton2AlignCenter, null);
        jToolBar2.add(jButton2AlignLeft, null);
        jToolBar2.add(jButton2Underline, null);
        jToolBar2.add(jButtonCenter, null);
        jToolBar2.add(jButtonFitHoz, null);
        jToolBar2.add(jButtonFitVer, null);
        jToolBar2.add(jButtonDelete, null);
        jToolBar2.add(jButton2Italic, null);
        jToolBar2.add(jButton2Bold, null);
        jToolBar2.add(jButton2Text, null);
        jToolBar2.add(jComboBox2Font, null);
        jToolBar2.add(jComboBox2Size, null);
        jToolBar2.add(jComboBox2Scale, null);
