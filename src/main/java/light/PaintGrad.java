...
public class PaintGrad
{
    ...
    public static void rollOver(Graphics g, int x, int y, int w, int h)
    {
        ...
        /*
        g.setColor(Color.decode("#B48BF3"));
        //g.drawRect(x, y + 2, w - i * 2 + 1, h - i * 2 - 3);
        //g.drawLine(x + 3, y + 2, w - i * 2 + 1 - 3 , y + 2);
        //g.drawLine(x + 3, h - i * 2 - 1, w - i * 2 + 1 - 3 , h - i * 2 - 1);
        int[] x2 = { w - i * 2, w - i * 2, w - i * 2 - 6 };
        int[] y2 = { h - i * 2 - 6, h - i * 2, h - i * 2 };
        g.fillPolygon(x2, y2, 3);
        /*
        int[] x3 = { x + 2 , x + 2 , x + 2 + 5 };
        int[] y3 = { y + 2 , y + 2 + 5, y + 2};
