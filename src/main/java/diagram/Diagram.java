...
public class Diagram extends JPanel {
	...
	public Diagram(JFrame frame) {
		...
		JScrollPane _toolBarScrollPane = new JScrollPane(_toolBar, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		
		_contentPane = new JLayeredPane();
		JScrollPane _contentScrollPane = new JScrollPane(_contentPane, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		...
		JScrollPane _tableScrollPane = new JScrollPane(_jTable, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
