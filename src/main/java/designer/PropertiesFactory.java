...
public class PropertiesFactory
{
    ...
    {
        ElementProperties properties = new ElementProperties(jComponent);
        //properties.addProperty(new SetTextCommand ( (DesignerComponent) jComponent, "Name", "Name"));
        addDisplayProperties(properties, jComponent);
        addBasicProperties(properties, jComponent);
        /*
        JComboBox comboBox = (JComboBox) jComponent;
        System.out.println("COMMAND COUNT: "+comboBox.getItemCount());
        for ( int i = 0 ; i < comboBox.getItemCount() ; i ++ )
        {
            SimPropertyChoice simChoice = (SimPropertyChoice) comboBox.getItemAt(i);
            properties.addProperty(new ChangeChoiceNameCommand(  (DesignerComponent) jComponent, simChoice ));
        }
            */
        return properties;
    }
