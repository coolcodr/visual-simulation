...
import designer.ChartSet;
import designer.DiagramComponentSetPanel;
import designer.DiagramSourceAnalysisList;
import designer.DiagramSourceList;
...
public class WorkEditPane extends JPanel implements MouseListener, MouseMotionListener, KeyListener, DropTargetListener {
     ...
     * 
     */
    private static final long serialVersionUID = -5039726228898538512L;
    // Componet Page
    ...
    public void paint(Graphics g) {
        ...
        // Graphics g2d = g;
        // BufferedImage doubleBuffer = new BufferedImage (size.width,
    ...
    public void drop(DropTargetDropEvent event) {
        ...
        try {
            text = event.getTransferable().getTransferData(DataFlavor.stringFlavor).toString();
        ...
        if (DiagramSourceList.selectedObject == null && DiagramSourceAnalysisList.selectedObject != null && DiagramSourceAnalysisList.selectedObject instanceof ChartSet) {
            ...
            JLabel label = new JLabel("Simultation Chart " + s, SwingConstants.CENTER);
...
class DragBound extends JComponent {
     ...
     * 
     */
    private static final long serialVersionUID = 6069656032837169569L;
    /*
     * public void paint ( Graphics g ) { g.setColor(Color.gray); g.drawRect(0,
     * 0, getSize().width-1, getSize().height-1); }
     */
}
