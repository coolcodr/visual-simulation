...
public class Exporter {
	...
	public Element createDiagramElementTag() {
		...
		//parentNode.appendChild(_diagramElementTag);	//append DiagramElement element to document 
		...
		((Element)_diagramElementTag).appendChild(_elementTypeTab);	//Append child elemntType to element*/
		return _diagramElementTag;
	}	
	
		
	//abstract public void exportDetail(Element _diagramElementTag, DiagramElement e);
	

	//abstract public void exportElement(DiagramElement _diagramElement, Node _parentNode);
	//abstract public Document exportAssociation(Association _association, Node _parentNode);
