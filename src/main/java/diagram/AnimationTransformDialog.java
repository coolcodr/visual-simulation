...
import animation.AnimationTransform;
...
public class AnimationTransformDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = -88520484842067733L;
    Object _value;
    Property _property;
...
class AnimationTableModel extends AbstractTableModel {
     ...
     * 
     */
    private static final long serialVersionUID = -7674646595288188220L;
    ...
    final String[] columnNames = { "From Animation", "To Animation" };
