...
public class CoverComponentFrame extends JComponent
{
    ...
    public CoverComponentFrame(int position, CoverComponent coverComponent)
    {
        ...
        this.moveListener = new MoveListener(position, coverComponent);
    ...
    public void repaintImage()
    {
        ...
        //if ( position == 1 && coverComponent.coverSize == 4  ) i = 1 ;//- coverComponent.getSize().height % size ;

        if ( position == 1 && coverComponent.getSize().height % 2 == 0 ) i = 1;

        if ( coverComponent.coverSize == 4 || gap == 6 ) width -= 1;
		//if ( coverComponent.coverSize == 4 && position == 1 ) width -=1;
        if ( coverComponent.getSize().height % 2 == 0 && position == 1 ) width -=1;
        ...
        if ( position == 3 && coverComponent.getSize().width % 2 == 0 ) j = 1;
        //if ( (position == 3 && gap == 6) ) j = 1;
        if ( position == 3 && gap == 5 && coverComponent.getSize().width % 2 == 0 ) ++ height ;
        if ( coverComponent.coverSize == 4 || gap == 6 ) height -= 1;
        if ( coverComponent.coverSize == 4 && position == 3 ) height -= 1;
        //if ( coverComponent.getSize().width % 2 == 0 && position == 3 ) height -= 1;
        ...
        int x = 0;
        int f = 0;
        if ( coverComponent.coverSize == 4 ) { j = j ; f = 0; }
    ...
    public void paint(Graphics g)
    {
    	...
    	if ( (position == 1 && gap == 6) )//|| (position == 1 && coverComponent.coverSize == 4))
