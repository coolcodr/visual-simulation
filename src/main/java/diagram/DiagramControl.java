...
public class DiagramControl implements MouseListener, MouseMotionListener {
    ...
    private Associations _associations = new Associations(); // keeping the
                                                             // associations
...
//added by matthew
    ...
    /*
     * public void addAssociation(DiagramElement parent, DiagramElement child,
     * String type, int x, int y) { _associations.add(new Association(parent,
     * child, Association.CONNECTION, x, y)); }
     */
    ...
    public DiagramElement addDiagramElement(DiagramElementType type, int x, int y) {
        try {
            ...
            // DiagramElement element = new
            // DiagramElement(_selectedDiagramElementType);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
...
//			_selectedElements=null;
    ...
    public void clearDiagram() {
        ...
        _associations = new Associations();
    }
    ...
    public void exportDiagram() {
         ...
         * ().elementAt(i)); System.out.println("Export diagram");
         */
    ...
    public void cloneElement(DiagramElement de, boolean isCut) {
        ...
        if (!isCut) {
            if (de.getType().isShape()) {
                ...
                _de.setPane((JLayeredPane) getDiagram().getContentPane());
                _de.setOpaque(true);
        ...
        if (isCut) {
            ...
            for (int i = 0; i < _selectedElements.size(); i++) {
                ...
                if (de.getType().isShape()) {
                    ...
                    de.setPane((JLayeredPane) getDiagram().getContentPane());
                    de.setOpaque(true);
            ...
            for (int i = 0; i < as.size(); i++) {
                ...
                if (a.getConnector() != null) {
                    ...
                    connectorDe.setPane((JLayeredPane) getDiagram().getContentPane());
                }
            }
