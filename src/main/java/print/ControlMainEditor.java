...
public class ControlMainEditor {
    ...
    public void saveAs() {
        saveControl.saveAs(printEditor);
    }

    public void save() {
        saveControl.save(printEditor);
    }
    ...
    public void load() {
        reportDocument = saveControl.load(printEditor);
        load(reportDocument);
    }
    ...
    public void load(ReportDocument reportDocument) {
        ...
        for (int i = 0; i < reportDocument.getNumOfReportPage(); i++) {
            if (reportDocument.getReportPage(i).getDiagram()[0].getObjectComponent().getChart() != null) {
                reportDocument.getReportPage(i).getDiagram()[0].getObjectComponent().getChart().display();
            }
        }
