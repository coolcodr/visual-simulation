...
public class SummaryServiceTimeMeanPane extends JPanel {

    /**
     * 
     */
    private static final long serialVersionUID = -2662573337621009774L;
    private AnalysisTool2[] _analysisTools;
    private double[] _data;

    private double _max = 1;

    public SummaryServiceTimeMeanPane() {
        super();
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Summary of Means of Service Times", p1x / 2, p1y / 2);

        g.drawString("" + _max, p1x - 20, p1y);
