...
public class LightScrollBarUI extends BasicScrollBarUI
{
    ...
    protected void installDefaults()
    {
        ...
        this.scrollbar.setBorder(LightLoweredButtonBorder.getScrollButtonBorder());
    }
    ...
    protected void paintThumb(Graphics g1, JComponent jcomponent, Rectangle r)
    {
        ...
        */
        ...
        g.setColor(LightLookAndFeel.getPrimaryControlHighlight());
        //g.drawLine(x + j + 1, y + j + 1, x + j + 1, y + j + height - j - 2);
        //g.drawLine(x + j + 1, y + j + 1, x + j + width - j - 2 , y + j + 1);

        g.setColor(Color.lightGray);
        //g.drawLine(x + j + 1, y + j + 1, x + j + 1, y + j + 1 + height - j - 1);
        //g.drawLine(x + j + 1, y + j + 1 + height - j - 2, x + j + 1 + width - j - 1 ,y + j + 1 + height - j - 2);
