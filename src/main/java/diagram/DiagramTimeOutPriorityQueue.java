...
public class DiagramTimeOutPriorityQueue extends DiagramMessageQueue {

    /**
     * 
     */
    private static final long serialVersionUID = -1932049499126964225L;

    public DiagramTimeOutPriorityQueue() {
        super();

        _properties.add(new Property("java.lang.String", "Name", new String("TimeOUt Priority")));
