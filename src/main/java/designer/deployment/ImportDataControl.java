    ...
    public void loadData() throws InvalidDataException {
        ...
        if (root.getNodeType() == Node.ELEMENT_NODE) {
            ...
            for (int i = 0; i < inputNodeCount; i++) {
                ...
                if (!inputComponent.getName().equalsIgnoreCase(nameNode.getValue()) || !inputComponent.getSetMode().equalsIgnoreCase(typeNode.getValue())) {
                    throw new InvalidDataException("Invalid data file for this simultation model");
                }
            ...
            for (int i = 0; i < internalInputNodeCount; i++) {
                ...
                if (!inputComponent.getName().equalsIgnoreCase(nameNode.getValue() + "|" + modeNode.getValue()) || !inputComponent.getSetMode().equalsIgnoreCase(typeNode.getValue())) {
                    throw new InvalidDataException("Invalid data file for this simultation model");
                }
