...
public class MainFrame extends JFrame
{
    ...
    private void init( String path )
    {
        ...
        try
        {
            //File inFile = new File("F:\\Kenny's folder\\Kenny's works\\Software Engineering year3\\project work3\\Horst\\DeploymentDesigner\\vSim1901\\src\\TestingDeploymentObjects.dat");
            File inFile = new File(path);
            //File inFile = new File("E:\\Temp\\new vSim\\classes\\TestingDeploymentObjects.dat");
        ...
        this.deployObjectFactory = new DeployObjectFactory(deployObject);
        ...
        //The add all input component (nested or says internal parameter) to deployObject
        ...
        //To add all frame (JDialog), and also at these time, add those input object to these frame
        for ( int i = 0 ; i < deployObject.getFrameObjectConunt() ; i ++ )
        {
            ...
            if ( frameComponent.getID().equalsIgnoreCase("main") ) {
                ...
                this.setTitle(jDialog.getTitle());
        ...
        for ( int i = 0 ; i < deployObject.getActionObjectConunt() ; i ++ )
        {
            ...
            //TEMP
            //actionComponent.setActionInput((InputComponent)deployObject.getInputObject(0));
        }*/
    ...
    /*
    private void resetActionControl( MainControl mainControl )
    {
        for ( int i = 0 ; i < deployObject.getActionObjectConunt() ; i ++ )
        {
            DeployActionComponent actionComponent = deployObject.getActionObject(i);
...
//        MainControl mainControl = null;
        ...
        /*
        try{
            designer.SimpleClassLoader classLoader = new designer.SimpleClassLoader();
            Class controlClass = classLoader.loadClass("designer.MainControl");
            System.out.println("++ Class: "+controlClass);
            Class[] classArray = new Class[] { DeployObjectFactory.class };
            System.out.println("++ ClassArray: "+classArray);
            Constructor controlContructor = controlClass.getConstructor(classArray);
            System.out.println("++ Contructor :"+controlContructor);
            Object[] objectArray = new Object[] {deployObjectFactory};
            System.out.println("++ ObejctArray :" +objectArray);
            mainControl = (MainControl)controlContructor.newInstance(objectArray);
            System.err.println("++ MainControl: "+mainControl);
            //runMethod = controlClass.getMethod("startRun",null);
            //System.err.println("++ Method :"+runMethod);
            //mainControl = runMethod.invoke(mainControl, null);
