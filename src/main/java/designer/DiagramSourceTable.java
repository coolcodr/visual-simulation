...
import table.JTreeTable;

public class DiagramSourceTable extends JTreeTable // implements
                                                   ...
                                                   // MouseListener
{
     ...
     * 
     */
    private static final long serialVersionUID = 3067209991497231513L;
...
//setTreeTableModel(propertyTree);
        ...
        // getTree().setCellRenderer(renderer);
        /*
         * getTree().updateUI(); getTree().repaint(); renderer.updateUI();
         * renderer.repaint(); this.updateUI(); this.repaint();
         */
        /*
         ...
         * root.add(node1); root.add(node2); node2.add(node3); node3.add(node4);
         */
         ...
         * renderer.repaint(); this.updateUI(); this.repaint();
         */
        // this.getColumnModel().getColumn(1).setCellEditor(new CEditor(new
        // JTextField()));
        // this.getColumnModel().getColumn(1).setCellRenderer(checkBoxRenderer);

    }
    /*
     * public void setProperties(ElementProperties properties) { this.properties
     * = properties;
     * 
     * //DefaultMutableTreeNode root = new DefaultMutableTreeNode("Properties");
     * root.removeAllChildren(); //root = new
     * DefaultMutableTreeNode("Properties");
     * 
     * Vector props = properties.getProperties();
     * 
     * for (int i = 0; i < props.size(); i++) { PropertyCommand property =
     * (PropertyCommand) props.elementAt(i); root.add(new
     * DefaultMutableTreeNode(property)); }
     * 
     * //propertyTree = new PropertiesTree( (Object) root);
     * //setTreeTableModel(propertyTree);
     * 
     * //propertyTree = new PropertiesTree(root); //this.root = root;
     * 
     * //setTreeTableModel(propertyTree);
     * 
     * repaint(); UIDesigner.mainWindow.repaint(); }
     */
}
